...
// Fetch user address based on latitude and longitude
...
const ShoppingCartModal = () => {
  ...
  const { cart, showCart, toggleShowCart, removeFromCart, totalPrice } = useCartState(state => ({
    cart: state.cart,
  ...
  const formatAddress = (address: any) => {
    ...
    return `${address.road || ""}, ${address.neighbourhood || ""}, ${address.suburb || ""}, ${address.city || address.city_district || ""}, ${address.state || ""}, ${address.postcode || ""}, ${address.country || ""}`;
  };
